...
public class Tweet : SocialContent, CustomStringConvertible
{
    ...
    init?(data: NSDictionary?) {
        ...
        retweets = data?.valueForKeyPath(TwitterKey.Retweets) as? Int
        fabourites = data?.valueForKeyPath(TwitterKey.Favourites) as? Int
    ...
    struct TwitterKey {
        ...
        static let Favourites = "favourite_count"
        struct Entities {
...
//            }
            ...
            return UIImage(named: "squareTweet")
        }
        return nil
    }
